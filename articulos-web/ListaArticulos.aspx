...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row d-flex justify-content-center">
        <div class="col-md-12 col-lg-10  fondoblanco mt-5 rounded-5">
            ...
            <asp:GridView runat="server" ID="dgvArticulos" DataKeyNames="Id" class="table table-striped mt-3" AutoGenerateColumns="false" OnSelectedIndexChanged="dgvArticulos_SelectionIndexChanged">
                <Columns>
